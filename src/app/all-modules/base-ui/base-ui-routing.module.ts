  ...
  { 
    ...
    children: [
        ...
        { 
          ...
          { 
            path: 'lightbox', 
            loadChildren: () => import('./lightbox/lightbox.module').then(m => m.LightboxModule)
          }, 
          { 
            path: 'media', 
          ...
          { 
            path: 'offcanvas', 
            loadChildren: () => import('./offcanvas/offcanvas.module').then(m => m.OffcanvasModule) 
          }, 
          { 
            path: 'pagination', 
          ...
          { 
            path: 'progress-bars', 
            loadChildren: () => import('./progress-bars/progress-bars.module').then(m => m.ProgressBarsModule) 
          }, 
          { 
            path: 'placeholders', 
          ...
          { 
            path: 'sweetalerts', 
            loadChildren: () => import('./sweetalerts/sweetalerts.module').then(m => m.SweetalertsModule) 
          }, 
          { 
            path: 'tabs', 
